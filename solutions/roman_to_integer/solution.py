class Solution:
    ...
    В стеке мы храним частичные суммы,
    так как римские цифры могут то увеличиваться, то уменьшаться.
    Так же не забываем, что разряды идут так же с лева на право

    Если новое число оказалось меньше, значит мы закончили расчет предыдущей
    частичной суммы("разряда") и готовы добавить новое число.
    Если новое число оказалось равное текущему,
      значит его надо приплюсовать к текущему.
