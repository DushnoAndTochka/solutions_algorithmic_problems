...
class Solution:
    def has_groups_size_x(self, deck: list[int]) -> bool:
        # Получаем словарь из списка - [1,2,3,1] -> {1: 2, 2: 1, 3: 1}
        # Ключ словаря - это элемент списка,
        # а значение - количество элементов в списке
        ...
        for value in values:
            ...
            # Если НОК равен 1, то значит минимальная
            # группа - это 1 и на группы,
