...
class Solution(object):
    ...
    которых равна таргету, а значит если из таргета вычесть число,
    то нам нужно найти полученное

    Например
    target = 10, а мы нашли число 7. Значит нам надо еще 3 и
    тогда сумма 7 и 3 даст нам таргет

    Что бы не бегать по всем числам, мы запоминаем число
    которое уже 'потрагали' и его индекс.
    Дальше берем разницу между таргет и новым число,
    и смотрим не находили ли мы этого числа.
    """
